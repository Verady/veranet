...
This package exposes the program `veranet`. To install, use the `--global` flag.

```
npm install -g @verady/veranet
```
...
```
npm install @verady/veranet --save
```

Then you can require the library with:

```
const veranet = require('@verady/veranet');
```
