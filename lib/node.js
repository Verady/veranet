...
class Node extends kad.KademliaNode {
  ...
  createSnapshot(options, callback) {
    ...
    const job = {
      ...
      get satisfied() {
        // TODO: Return true if there is a consensus
        // TODO: Return true if all workers have completed
      },
      get consensus() {
        // TODO: Return the result returned most if it's more than the
        // TODO: options.consistency value, otherwise null
      },
      pool: options.pool,
